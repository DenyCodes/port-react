      ...
      <Content>
        ...
        <DescricaoDiv>
          ...
          <p>
            ...
            personalizados por tipo de perfil; Cálculo de rotas e tempo estimado
            de deslocamento via Google Maps Directions API; Filtros por região,
      ...
      <Content>
        ...
        <DescricaoDiv>
          ...
          <p>
            ...
            dinâmica. Com um design minimalista e funcional, o eFood permite aos
            usuários navegar pelo menu, adicionar itens ao carrinho e finalizar
            a compra com facilidade. Este projeto demonstra minha habilidade em
            desenvolver aplicações full stack, integrando frontend e backend de
            forma harmoniosa para criar uma experiência de usuário fluida e
            agradável.
          </p>
          <CampoTag>
      ...
      <Content>
        ...
        <DescricaoDiv>
          ...
          <p>
            ...
            para criar uma interface de usuário dinâmica e altamente responsiva.
            A plataforma permite que os usuários explorem uma vasta biblioteca
            de jogos, assistam a transmissões ao vivo e se conectem com outros
            jogadores. O ePlay demonstra minha habilidade em criar aplicações
            web complexas e escaláveis, focando na performance e na experiência
            do usuário.
          </p>
          <CampoTag>
            <span>typescript</span>
      ...
      <Content>
        ...
        <DescricaoDiv>
          ...
          <p>
            ...
            minhas habilidades em criação de interfaces de usuário atraentes e
            funcionais. Este projeto foi construído utilizando React.js e
            Next.js, proporcionando uma experiência de navegação fluida e
            responsiva. A plataforma permite que os usuários explorem uma ampla
            gama de conteúdos, incluindo filmes, séries e documentários, com uma
            interface visualmente atraente e intuitiva. O Disney+ Clone destaca
            minha capacidade de recriar interfaces complexas e otimizar a
